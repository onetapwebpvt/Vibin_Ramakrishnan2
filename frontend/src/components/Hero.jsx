...
function Hero() {
  ...
  return (
    <div className="min-w-full bg-gradient-to-br from-gray-50 via-slate-50 to-gray-100">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-start py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-12 lg:px-24 gap-8 lg:gap-16">
